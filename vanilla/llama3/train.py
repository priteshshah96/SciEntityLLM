...
# Define the path for the output folder and cache
generated_output_dir = './llama3_generated_entity_train'
cache_dir = "./cache"
...
MAX_ENTITIES = 50  # Maximum number of entities to extract
...
prompt_template = """
Extract and list the unique scientific entities from the following text. Focus on scientific terms, methods, metrics, tasks, materials, and other scientific concepts. Do not repeat entities. Categorize each entity using ONLY one of the following tags: Task, Method, Metric, Material, or Other-Scientific-Term. If you find an entity that doesn't fit these categories, rephrase it to fit one of the five categories.
...
- Do not use any other categories besides these five.
...
raw_text_dir = "/home/shahprit/vanilla/train"
