...
generated_output_dir = './llama2_generated_entities_train'
...
raw_text_dir = "/home/shahprit/explanation/train"
...
for filename in sorted(os.listdir(raw_text_dir)):
    if filename.endswith(".txt") and filename not in processed_files:
        ...
        try:
            ...
            with open('processed_files_train.json', 'w') as f:
...
files_not_matched_path = os.path.join(script_dir, 'files_not_matched_train.json')
