...
def main():
    ...
    gold_entities_dir = os.path.join(base_dir, "gold_entities_train")
    generation_dir = os.path.join(base_dir, "llama3", "llama3_generated_entities_train")
    eval_dir = os.path.join(base_dir, "llama3", "llama3_eval_train")
